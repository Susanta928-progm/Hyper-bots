...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/MOVIE_SEARCHING_GROUP_ACX')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002334193967'))  # set shortner log channel
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002189849843')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MOVIE_SEARCHING_GROUP_ACX') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
